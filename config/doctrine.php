...
use System\Doctrine\LocaleType;
    ...
    */
    'managers'                   => [
        'default' => [
            ...
            'namespaces' => [
                'Cobiro\\Accounts\\Domain',
                'Cobiro\\Contents\\Domain',
                'Cobiro\\Sites\\Domain',
            ],
            'paths'      => [
                base_path('src/Components/Accounts/Adapters/Infrastructure/Database/Doctrine') => 'Components\\Accounts\\Domain',
                base_path('src/Components/Contents/Adapters/Infrastructure/Database/Doctrine') => 'Components\\Contents\\Domain',
                base_path('src/Components/Sites/Adapters/Infrastructure/Database/Doctrine')    => 'Components\\Sites\\Domain',
            ],
